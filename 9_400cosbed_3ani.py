...
Amax = 321.4
#Amax = np.max(bumpfunc) #321.378117416
#print(Amax)
...
# z=5300
# s2 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (9/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (9/10)**mi 
#
# s3 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (8/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (8/10)**mi  
#
# s4 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (7/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (7/10)**mi  
#
# s5 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (6/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (6/10)**mi  
#
# s6 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (5/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (5/10)**mi  
#
# s7 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (4/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (4/10)**mi  
#
# s8 = bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125) + (3/10*(iceHeight-(BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0+0.5+0.25+0.125)+bed))) * (3/10)**mi  
#
...
#print(Sbump,meshVx) #4978220.286247666 0.10710953121528549
#meshVx = 0.25
...
for index in mesh.specialSets["MinI_VertexSet"]:
    z = mesh.data[index,2]
    if zmin<=z<=zmax:
        if mesh.data[index][1]<=bed+BumpAmplitude/Amax*((np.cos((z-zmin)*k1+np.pi)+1.)*BA1/2.+(np.cos((z-zmin)*k2+np.pi)+1.)*BA2/2.+(np.cos((z-zmin)*k3+np.pi)+1.)*BA3/2.+(np.cos((z-zmin)*k4+np.pi)+1.)*BA4/2.)/(1.0 + 0.5 + 0.25 + 0.125):
            loadA+=index
    elif z>zmax:
...
# maxViscosityIceFn  = fn.misc.constant(1e+17 / 3.1536e7)
# viscosityFnRock = fn.misc.constant(1e20 / 3.1536e7)
#
# V1 = 0.5 * (A0smallT * fn.math.exp(-QsmallT / (R*(particleTemperature + 273.)))) ** (-1./n) * (strainRate_2ndInvariantFn**((1.-n) / float(n)))
# V2 = 0.5 * (A0highT * fn.math.exp(-QhighT / (R*(particleTemperature + 273.)))) ** (-1./n) * (strainRate_2ndInvariantFn**((1.-n) / float(n)))
# V1 = V1 * 1e6 #pa*a
...
# viscosityFn3=viscosityFn-viscosityFn2
# particleViscosity.data[:] = viscosityFn.evaluate(swarm)
# shearStressFn = strainRate_2ndInvariantFn * viscosityFn3 * 2.0

# def flow2(rotate_caxes = True):
#     
#     global calibrate_pressure
#     global advector1
#     global advector2

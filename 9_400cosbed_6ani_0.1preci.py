...
minViscosityIceFn  = fn.misc.constant(6e+12 / 3.1536e7)
...
#viscosityFnAir2    = 0.0
viscosityFnIce2    = (1-1/6) * viscosityFnIce
viscosityMap2 = {
                materialA:  0.,
...
meshVx = (meshVz*MODEL_DATA['MAX_X']*(iceHeight-bed)+preciRate*MODEL_DATA['MAX_X']*MODEL_DATA['MAX_Z'])/((iceHeight-bed)*MODEL_DATA['MAX_Z']-Sbump)
#print(Sbump,meshVx) #4978220.286247666 0.13038539553752534  # 0.15 4978220.286247666 0.14125084516565245
#meshVx = 0.25
...
def flow(rotate_caxes = True):
    ...
    if sfsize > 0:
        ...
        #    print('air', np.min(swarm.data[location1,1]),np.max(swarm.data[location1,1]))
        airiceSwarm.data.setflags(write=1)
